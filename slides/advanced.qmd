...
This is the **core loop** of Git. - `git status`: See which files have changed. - `git add <file>`: Stage changes for a file. - `git add .`: Stage all changes. - `git commit -m "Your commit message"`: Save the staged changes to your local history.
